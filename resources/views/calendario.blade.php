        ...
        <div class="card_bod">
            ...
            @if (session('errors') )
                <div class="alert alert-danger" role="alert">
                    Los cambios se guardaron pero tener encuenta  que:
                    <ul>
                ...
                @foreach($workDays as $key=>$workDay)
                    <tr>
                        ...
                        <th>
                            <div class="row">
                                <div class="col">
                                    <select name="mornig_start[]"  class="form-control">
                                     @for ($i=5;$i<=11;$i++)
                                        <option value="{{ ($i<10 ?'0' :''). $i}}:00"
                                        @if ($i.':00 AM' == $workDay->mornig_start ) selected @endif >
                                         {{$i}}:00 AM
                                        </option>

                                        <option value="{{ ($i<10 ?'0' :'').$i}}:30"
                                        @if ($i.':30 AM' == $workDay->mornig_start ) selected @endif >
                                         {{$i}}:30 AM
                                        </option>
                                     @endfor
                                    </select>
                                ...
                                <div class="col">
                                    <select name="mornig_end[]" class="form-control">
                                        @for ($i=5;$i<=11;$i++)
                                        <option value="{{ ($i<10 ?'0' :'').$i}}:00"
                                            @if ($i.':00 AM' == $workDay->mornig_end ) selected @endif >
                                            {{$i}}:00 AM</option>
                                        <option value="{{ ($i<10 ?'0' :'').$i}}:30"
                                            @if ($i.':30 AM' == $workDay->mornig_end ) selected @endif >
                                            {{$i}}:30 AM</option>
                                        @endfor
